...
bounded per-request tool-call budget. `recent_build_context` is Agent-side context only: it
returns the lightweight list of objects from the most recent successful build. `analyze_scene`
